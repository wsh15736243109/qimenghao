...
/**
 * Created by Joy_Yao  on 2018/4/17 0006.17:46
 */
...
public  class YaoSharedPreferences {

    private static SharedPreferences yaoSharedPreferences;
    private static SharedPreferences getSp() {
        if (yaoSharedPreferences == null) {
            yaoSharedPreferences = SelfApp.getApp().getAppContext().getSharedPreferences("YaoSharedPreferences", Context.MODE_PRIVATE);
        }
        return yaoSharedPreferences;
    }
    ...
    private static Object get( String key)
        ...
        String wordBase64 = getString( key,null);
        // 将base64格式字符串还原成byte数组
        if (wordBase64==null|| TextUtils.isEmpty(wordBase64)) { //不可少，否则在下面会报java.io.StreamCorruptedException
            return null;
        }
