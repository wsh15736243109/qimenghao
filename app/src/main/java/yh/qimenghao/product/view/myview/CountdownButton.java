...
public class CountdownButton extends android.support.v7.widget.AppCompatButton implements View.OnClickListener {
    ...
    private void initTimer() {
        ...
        timerTask = new TimerTask() {
            ...
            public void run() {
                ...
                try {
                    ((Activity)(context)).runOnUiThread(() -> CountdownButton.this.setBackgroundResource(R.mipmap.register));
                }catch (Exception e){}
    ...
    public void onClick(View v) {
       if(MoreUtils.isNetworkAvailable(context)) start();
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            CountdownButton.this.setText(afterText+"("+length / 1000+")");
            length -= 1000;
            if (length < 0) {
                CountdownButton.this.setEnabled(true);
                CountdownButton.this.setText(beforeText);
                CountdownButton.this.setBackgroundResource(R.mipmap.register);
                clearTimer();
                length = 30 * 1000;
            }
        }
